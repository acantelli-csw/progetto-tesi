...
class ChunkingConfig:
    ...
    def __post_init__(self):
        ...
        if self.recursive_separators is None:
            ...
            self.recursive_separators = standard_separators
...
def main():
    ...
    config_semantic_percentile = ChunkingConfig(
        ...
        semantic_breakpoint_threshold_amount=99
    )
    ...
    config_semantic_std = ChunkingConfig(
        ...
        semantic_breakpoint_threshold_amount=1
    )
    ...
    selected_config = config_semantic_percentile
